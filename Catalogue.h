...
//----------------------------------------------------- Méthodes publiques
    ...
    // Mode d'emploi :
    // Méthode permettant de sauvegarder depuis un fichier passé en paramètre tous les trajets contenu dans le
    // catalogue actuel de l'application selon le critère de sélection, également passé en paramètre.
    //
    // Contrat :
    // Il faut que le critère soit valide (présent dans l'enum CritereSelection)
